...
- `config` (String) JSON-encoded configuration parameters (e.g. temperature, max_tokens).
...
- `search_parameters` (String) JSON-encoded Algolia search parameters.
...
- `headers` (Map of String) Additional headers to send with MCP requests.
