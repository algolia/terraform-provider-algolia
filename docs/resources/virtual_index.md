...
- `primary_index_name` (String) The primary index linked to this virtual replica. Changing it forces replacement: Algolia has no way to move a replica between primaries.
